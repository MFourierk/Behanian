...
urlpatterns = [
    ...
    path('stock/etat-date/excel/', views.etat_stock_date_bar_excel, name='etat_stock_date_excel'),
    path('mouvements/imprimer/', views.mouvements_print_bar, name='mouvements_print'),
    path('mouvements/document/', views.mouvements_doc_bar, name='mouvements_doc'),
    path('mouvements/excel/', views.mouvements_excel_bar, name='mouvements_excel'),
