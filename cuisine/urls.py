...
urlpatterns = [
    ...
    path('etat-stock/date/', views.etat_stock_date_cuisine, name='etat_stock_date'),
    path('etat-stock/date/imprimer/', views.etat_stock_date_cuisine_print, name='etat_stock_date_print'),
    path('etat-stock/date/excel/', views.etat_stock_date_cuisine_excel, name='etat_stock_date_excel'),
