...
urlpatterns = [
    ...
    path('checkout/finalize/<uuid:temporary_ticket_id>/', views.finalize_checkout, name='finalize_checkout'),
    path('consommation/add/<int:reservation_id>/', views.ajouter_consommation, name='ajouter_consommation'),
    path('ticket/<uuid:temporary_ticket_id>/print/', views.ticket_print, name='ticket_print'),
