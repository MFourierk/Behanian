...
urlpatterns = [
    ...
    path('checkout/finalize/<int:reservation_id>/', views.finalize_checkout, name='finalize_checkout'),
    path('consommation/add/<int:reservation_id>/', views.ajouter_consommation, name='ajouter_consommation'),
    path('ticket/<int:reservation_id>/preview/', views.ticket_preview, name='ticket_preview'),
    ...
    path('reservation/<int:reservation_id>/modifier-sejour/', views.modifier_checkin_en_cours, name='modifier_checkin_en_cours'),
