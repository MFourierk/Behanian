...
class TarifPiscineAdmin(admin.ModelAdmin):
    list_display = ['type_tarif', 'prix_unitaire']

@admin.register(AccesPiscine)
class AccesPiscineAdmin(admin.ModelAdmin):
    list_display = ['nom_client', 'type_client', 'prix_total', 'date_entree', 'date_sortie']
...
class ConsommationPiscineAdmin(admin.ModelAdmin):
    list_display = ['acces', 'produit', 'quantite', 'prix_unitaire']
